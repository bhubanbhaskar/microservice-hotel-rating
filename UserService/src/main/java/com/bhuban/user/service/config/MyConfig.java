package com.bhuban.user.service.config;

import com.bhuban.user.service.config.interceptor.RestTemplateInterceptor;
...
@Autowired
    ...
    public RestTemplate restTemplate(){
        ...
        interceptors.add(new RestTemplateInterceptor
                (manager(clientRegistrationRepository,authorizedClientRepository)));
